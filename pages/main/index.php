...
<h3>Sản phẩm mơí nhất</h3>
				<div class="row">
					...
					<div class="col-md-2">
						<a href="index.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>">
							...
							<p style="text-align: center;color:rgb(20 53 195)"><?php echo $row['tendanhmuc'] ?></p>
						</a>
					</div>
					<?php
					} 
				...
				<ul class="list_trang">
					...
					for($i=1;$i<=$trang;$i++){ 
					?>
						<li <?php if($i==$page){echo 'style="background: linear-gradient(108deg, #f7434c, #ff8949) !important;"';}else{ echo ''; }  ?>><a href="index.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					<?php
					} 
					?>
